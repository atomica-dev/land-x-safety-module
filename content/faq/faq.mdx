...
items:
  - header: What is LandX Safety Module?
    content: >
      ...
      Module") is a widely used safety mechanism to protect real-world farmers
      and users of leading DeFi Protocols by providing asset-backed guarantees
      ...
      Module"), the [LandX ISM](insurance.landx.fi "LandX Safety Module") is a
      security layer made of smart contracts and staked assets that protects the
      [LandX Protocol](landx.fi "LandX Protocol") and its users.
      ...
      programmatically, like interest rates in lending markets such as
