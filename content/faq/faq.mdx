...
items:
  ...
  - header: What is a stacking pool withdrawal delay?
    content: >
      Stakers can withdraw their funds after the withdrawal delay specified on
      the Pool Details page. For example, if the pool has a withdrawal delay of
      **14** day, and you submit a withdrawal request now, you can execute the
      withdrawal transaction **14** days later.
      ...
      * If the withdrawal request has expired, you should create another
      withdrawal request, you will be able to withdraw funds after 14 days after
      the withdrawal request submission.
